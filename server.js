    ...
    helmet({
        contentSecurityPolicy: {
            directives: {
                ...
                connectSrc: ["'self'", 'https://*.googleapis.com', 'https://*.google.com', 'https://*.googleusercontent.com'],
                objectSrc: ["'self'"],
                frameSrc: ["'self'", 'https://drive.google.com', 'https://docs.google.com', 'https://*.google.com'],
                frameAncestors: ["'self'"],
                baseUri: ["'self'"],
                formAction: ["'self'"],
            },
